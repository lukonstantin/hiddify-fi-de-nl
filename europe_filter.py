...
req = Request(
    SOURCE,
    headers={"User-Agent": "hiddify-europe-filter/1.0"}
)
...
if not nodes:
    raise SystemExit(
        "No European nodes found; refusing to overwrite europe.txt"
    )


header = [
    "# profile-title: 🇪🇺 EUROPE AUTO",
    "# profile-update-interval: 1",
    "# Auto-filtered from igareck/vpn-configs-for-russia",
    "# Countries: FI, DE, NL, PL, SE, FR, CH, AT, CZ, EE, LV, LT",
    f"# Count: {len(nodes)}",
    "",
]
